...
AQS使用了模板方法，指定了获取锁和释放锁的工作流程，具体的实现细节可以由自己的子类去实现

> ReetrantLock的实现分为公平锁与非公平锁，因此tryAcquire()方法就有两个实现方式，为此JUC设计了中间层Sync来实现
>
> -------AQS--------------------------
>
> -------------Sync-------------------
...
// 基本方法：父类或子类实现获取锁的各个步骤的方法
    // 由子类实现（注意protected关键字）
    protected boolean tryAcquire(int arg) {
        throw new UnsupportedOperationException();
    }
    
    // 父类实现的线程阻塞再重复尝试获取锁的方法
